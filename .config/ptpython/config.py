...
def configure(repl):
    ...
    # Catppuccin Mocha (hexes from official palette) :contentReference[oaicite:0]{index=0}
...
custom_ui_colorscheme = Style.from_dict(
    {
        ...
        # prompt / input area
        **default_ui_style,
        "prompt": "bg:#1e1e2e #cba6f7 bold",
        "prompt.dots": "bg:#1e1e2e #7f849c",
        "prompt.num": "bg:#1e1e2e #89b4fa bold",
        "prompt.name": "bg:#1e1e2e #94e2d5 bold",
        # main background / default text
        "background": "bg:#1e1e2e #cdd6f4",
        "text-area": "bg:#1e1e2e #cdd6f4",
        "line-number": "bg:#1e1e2e #6c7086",
        "line-number.current": "bg:#1e1e2e #bac2de bold",
        # status toolbar (bottom bar)
        "status-toolbar": "bg:#181825 #cdd6f4",
        "status-toolbar.key": "bg:#181825 #f5c2e7 bold",
        "status-toolbar.title": "bg:#181825 #a6e3a1 bold",
        "status-toolbar.text": "bg:#181825 #cdd6f4",
        "status-toolbar.sep": "bg:#181825 #45475a",
        # sidebar (help / settings)
        "sidebar": "bg:#181825 #cdd6f4",
        "sidebar.title": "bg:#181825 #cba6f7 bold",
        "sidebar.label": "bg:#181825 #bac2de",
        "sidebar.status": "bg:#181825 #cdd6f4",
        "sidebar.status.on": "bg:#181825 #a6e3a1 bold",
        "sidebar.status.off": "bg:#181825 #f38ba8 bold",
        # completion menu
        "completion-menu": "bg:#181825 #cdd6f4",
        "completion-menu.completion": "bg:#181825 #cdd6f4",
        "completion-menu.completion.current": "bg:#313244 #cdd6f4 bold",
        ...
        # search
        "search": "bg:#313244 #f9e2af",
        "search.current": "bg:#45475a #f9e2af bold",
        # validation / warnings
        "validation-toolbar": "bg:#181825 #f9e2af",
        "validation-toolbar.error": "bg:#181825 #f38ba8 bold",
    }
)
